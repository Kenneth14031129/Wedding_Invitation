    ...
    <main className="relative z-10 min-h-screen flex items-center justify-center">
      <div className="w-full max-w-6xl mx-auto px-4">
        ...
        <div className="text-center text-white space-y-6 md:space-y-10">
          {/* Title */}
          <h2 className="font-['Imperial_Script'] text-6xl sm:text-7xl tracking-wide text-white drop-shadow-lg mb-4 md:mb-8 mt-6 md:mt-10 text-center">
            Attire
          </h2>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between md:space-x-8 space-y-0 md:space-y-4">
            ...
            {/* Text Content */}
            <div className="w-full md:flex-grow p-4 md:p-8">
              {/* Semi-formal section */}
              <div className="mb-6 md:mb-10">
                <h3 className="font-['Playfair_Display'] text-xl sm:text-3xl uppercase tracking-wider mb-3 md:mb-6 text-white drop-shadow text-center">
                  SEMI-FORMAL
                </h3>
                <div className="space-y-2 md:space-y-3">
                  <p className="font-['Playfair_Display'] text-base sm:text-xl text-white drop-shadow text-center">
                    Gentlemen: Dress shirt or Coat and Tie
                  </p>
                  <p className="font-['Playfair_Display'] text-base sm:text-xl text-white drop-shadow text-center">
                    Ladies: Flowy Long or Knee length Dress
                  </p>
                  <p className="font-['Playfair_Display'] italic text-sm sm:text-lg text-white drop-shadow text-center">
              ...
              <div className="mb-6 md:mb-10">
                ...
                <div className="space-y-2 md:space-y-4">
                  <p className="font-['Playfair_Display'] text-base sm:text-xl font-medium text-white drop-shadow text-center">
                    Light Spring Pastel
                  </p>
                  <p className="font-['Playfair_Display'] italic text-sm sm:text-lg text-white drop-shadow leading-relaxed text-center">
              ...
              <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-4 md:mb-10">
                {[
                  ...
                  <div
                    key={index}
                    className={`w-8 h-8 sm:w-12 sm:h-12 rounded-full ${bgColor} border-2 border-white/70 shadow-md transition transform hover:scale-110`}
                  />
                ))}
              </div>
            </div>
            ...
            <div className="block md:hidden w-2/5 mx-auto mt-2 md:mt-4">
              <img
                src={AttireTheme}
                alt="Couple Attire"
                className="w-full h-auto rounded-lg shadow-lg"
